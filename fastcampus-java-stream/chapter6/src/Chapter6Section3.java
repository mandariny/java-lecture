...
public class Chapter6Section3 {
    public static void main(String[] args) {
        ...
        List<Integer> mappedNumberList = numberList.stream()
                .map(x -> x * 2)
                .collect(Collectors.toList());
//        System.out.println(mappedNumberList);
...
//        System.out.println(numberStringList);
        ...
        List<Long> orderCreateIdList = orders.stream()
                .map(Order::getCreatedByUserId)
                .collect(Collectors.toList());
        System.out.println(orderCreateIdList);
    }
}
